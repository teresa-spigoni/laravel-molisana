    ...
    <div class="big-container">
        ...
        <main class="products-main">
            ...
            <div class="container">
                ...
                <p class="productDescription"><?php echo $pastaArray[$idProduct]['descrizione']; ?></p> 
            </div>
            {{-- container --}}
